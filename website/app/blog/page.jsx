...
export const metadata = {
  ...
  description:
    "Explore practical coding guidance, parent resources, student stories and technology insights for young creators.",
  ...
  openGraph: {
    title: "Stories & Insights | Tech Talk Hub",

    description:
      "Practical coding guidance, parent resources and inspiring stories for families raising young creators.",
    ...
    images: [
      {
        url: `${SITE_URL}/blog-hero.png`,

        width: 1200,

        height: 630,

        alt: "Tech Talk Hub stories and insights",
      },
    ],
  },
  ...
  twitter: {
    ...
    description:
      "Coding guidance, parent resources and inspiring stories for young creators.",

    images: [`${SITE_URL}/blog-hero.png`],
  },
};
...
function CategoryBadge({
  ...
  return (
    <span
      className={`inline-flex w-fit items-center gap-2 rounded-full border px-3 py-1.5 text-[11px] font-black uppercase tracking-[0.12em] ${categoryStyle.background} ${categoryStyle.text} ${categoryStyle.border}`}
    >
      {showDot && (
        <span
...
function ArticleImage({
  ...
  if (!post?.cover_image_url) {
    return (
      <div className="flex h-full w-full items-center justify-center bg-gradient-to-br from-[#F6F2FF] via-[#EDF3FF] to-[#FFF1F5]">
        <div className="text-center">
          <span className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-white text-[#7651EF] shadow-sm">
            <BookOpen size={26} />
          </span>

          <p className="mt-4 text-xs font-black uppercase tracking-[0.16em] text-[#2947C7]">
            Tech Talk Hub
          </p>
        </div>
      </div>
  ...
  return (
    <Image
      ...
      alt={post.title || "Tech Talk Hub article"}
      fill
      priority={priority}
      sizes={sizes}
      className={`object-contain transition duration-500 group-hover:scale-[1.025] ${className}`}
    />
  );
}
    ...
    >
      {showAuthor && (
        <span className="inline-flex items-center gap-2">
          <span className="flex h-7 w-7 items-center justify-center rounded-full bg-[#F0EBFF] text-[#7651EF]">
            <Users size={14} />
          </span>
...
function BlogHero({
  ...
  return (
    <section className="relative overflow-hidden border-b border-purple-100 bg-gradient-to-br from-white via-[#FCFAFF] to-[#F1EBFF] pt-24 sm:pt-28">
      <div className="pointer-events-none absolute -left-32 top-10 h-80 w-80 rounded-full bg-[#A78BFA]/10 blur-[100px]" />

      <div className="pointer-events-none absolute -right-24 top-10 h-96 w-96 rounded-full bg-[#FF3F7F]/10 blur-[120px]" />
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        <div className="grid items-center gap-10 pb-10 pt-8 sm:pb-14 sm:pt-10 lg:min-h-[430px] lg:grid-cols-[0.95fr_1.05fr] lg:gap-8 lg:pb-12 lg:pt-4">
          <div className="relative z-10 mx-auto max-w-xl text-center lg:mx-0 lg:text-left">
            <span className="inline-flex items-center gap-2 rounded-full border border-purple-200 bg-white/90 px-4 py-2 text-[11px] font-black uppercase tracking-[0.15em] text-[#7651EF] shadow-sm">
              <Sparkles size={14} />

              Stories for young creators
            </span>

            <h1 className="mt-6 text-4xl font-black leading-[1.08] tracking-tight text-[#2947C7] sm:text-5xl lg:text-[3.4rem]">
              Ideas for{" "}
            ...
            <p className="mx-auto mt-5 max-w-lg text-base leading-8 text-slate-600 sm:text-lg lg:mx-0">
              Practical coding guidance,
              inspiring learner stories and
            ...
            <div className="mt-7 flex flex-wrap items-center justify-center gap-4 lg:justify-start">
              <Link
                href="#latest-stories"
                className="inline-flex items-center gap-2 rounded-full bg-[#FF3F7F] px-6 py-3 text-sm font-black text-white shadow-lg shadow-pink-500/20 transition hover:-translate-y-0.5 hover:bg-[#E93470]"
              >
                Explore stories
          ...
          <div className="relative mx-auto w-full max-w-[580px]">
            <div className="absolute -inset-4 rounded-[2.5rem] bg-gradient-to-br from-purple-100/70 via-transparent to-pink-100/70 blur-2xl" />

            <div className="group relative aspect-[16/10] overflow-hidden rounded-[2rem] border border-white/80 bg-[#F4F0FF] shadow-2xl shadow-purple-950/10">
              <Image
                src="/blog-hero.png"
                alt="Young learner discovering coding with Tech Talk Hub"
                fill
                priority
              ...
              <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-[#172554]/30 via-transparent to-transparent" />

              <div className="absolute bottom-4 left-4 right-4 flex items-center justify-between gap-3 rounded-2xl border border-white/60 bg-white/90 px-4 py-3 shadow-lg backdrop-blur-md sm:bottom-5 sm:left-5 sm:right-5">
                <div className="flex min-w-0 items-center gap-3">
                  <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-pink-100 text-[#FF3F7F]">
                    <Heart
                      size={18}
                      fill="currentColor"
                    />
                  ...
                  <p className="text-xs font-bold leading-5 text-[#2947C7] sm:text-sm">
                    Every child can become a
                    creator.
                  </p>
                </div>

                <Sparkles className="hidden h-5 w-5 shrink-0 text-[#7651EF] sm:block" />
              </div>
            </div>
          </div>
        </div>
...
function CategoryFilters({
  ...
  return (
    <section className="sticky top-0 z-30 border-b border-slate-100 bg-white/95 backdrop-blur">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="overflow-x-auto py-4">
          <div className="flex min-w-max items-center gap-2.5 lg:justify-center">
            {CATEGORIES.map(
              (category) => {
                ...
                return (
                  <Link
                    ...
                    href={href}
                    scroll={false}
                    className={`inline-flex items-center gap-2 rounded-full border px-4 py-2.5 text-xs font-bold transition sm:text-sm ${
                      active
                        ? "border-[#7651EF] bg-[#7651EF] text-white shadow-md shadow-purple-500/20"
                        : "border-slate-200 bg-white text-slate-600 hover:border-purple-200 hover:bg-purple-50 hover:text-[#7651EF]"
                    }`}
                  >
                    <Icon size={15} />
...
function FeaturedArticle({
  ...
  return (
    <section
      id="latest-stories"
      className="mx-auto max-w-7xl scroll-mt-32 px-5 pb-14 pt-12 sm:px-6 sm:pb-16 sm:pt-16 lg:px-8"
    >
      <div className="mb-7 flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
        <div>
          ...
          <h2 className="mt-2 text-3xl font-black tracking-tight text-[#2947C7] sm:text-4xl">
      ...
      <article className="group overflow-hidden rounded-[2rem] border border-purple-100 bg-white shadow-lg shadow-purple-950/[0.04] transition duration-300 hover:shadow-xl">
        <Link
          href={`/blog/${post.slug}`}
          className="relative block aspect-[16/9] w-full overflow-hidden border-b border-purple-50 bg-[#F8F5FF] lg:aspect-[2.1/1]"
        >
          <ArticleImage
            post={post}
            priority
        ...
        <div className="grid gap-6 p-6 sm:p-8 lg:grid-cols-[1fr_auto] lg:items-end lg:gap-10 lg:p-10">
          <div className="max-w-4xl">
            <CategoryBadge
              category={post.category}
            />

            <h3 className="mt-5 text-2xl font-black leading-tight tracking-tight text-[#2947C7] sm:text-3xl lg:text-4xl">
              <Link
                href={`/blog/${post.slug}`}
                className="transition hover:text-[#7651EF]"
              >
                {post.title}
              </Link>
            </h3>
          ...
          <Link
            href={`/blog/${post.slug}`}
            className="inline-flex w-fit items-center gap-2 rounded-full bg-[#7651EF] px-6 py-3 text-sm font-black text-white shadow-lg shadow-purple-500/20 transition hover:-translate-y-0.5 hover:bg-[#6240DD]"
          >
            Read article
  ...
  return (
    <article className="group flex h-full flex-col overflow-hidden rounded-[1.75rem] border border-slate-200 bg-white shadow-sm transition duration-300 hover:-translate-y-1 hover:border-purple-200 hover:shadow-xl hover:shadow-purple-950/[0.06]">
      ...
      <div className="flex flex-1 flex-col p-5 sm:p-6">
        ...
        <h3 className="mt-4 text-lg font-black leading-snug text-[#2947C7] sm:text-xl">
          <Link
            href={`/blog/${post.slug}`}
            className="transition hover:text-[#7651EF]"
          >
        ...
        <div className="mt-auto pt-6">
          <div className="flex items-center justify-between border-t border-slate-100 pt-4">
            ...
            <Link
              ...
              className="ml-3 flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-purple-50 text-[#7651EF] transition hover:bg-[#7651EF] hover:text-white"
            >
              <ArrowRight size={16} />
            </Link>
          </div>
...
function LatestArticles({
  ...
  return (
    <section className="border-y border-purple-50 bg-[#FCFAFF] py-16 sm:py-20">
...
function EmptyArticles({
  ...
  return (
    <section
      id="latest-stories"
      className="mx-auto max-w-5xl scroll-mt-32 px-6 py-16 sm:py-20"
    >
      <div className="overflow-hidden rounded-[2rem] border border-purple-100 bg-gradient-to-br from-white to-[#FCFAFF] shadow-sm">
        <div className="mx-auto max-w-2xl px-6 py-14 text-center sm:px-10">
          <span className="mx-auto flex h-16 w-16 items-center justify-center rounded-[1.4rem] bg-[#F0EBFF] text-[#7651EF]">
            <BookOpen size={29} />
          </span>

          <p className="mt-6 text-xs font-black uppercase tracking-[0.16em] text-[#FF3F7F]">
            {isFiltered
              ? "Nothing here yet"
              : "Stories coming soon"}
          </p>

          <h2 className="mt-3 text-3xl font-black tracking-tight text-[#2947C7] sm:text-4xl">
            {isFiltered
          ...
          <p className="mx-auto mt-4 max-w-xl text-base leading-8 text-slate-600">
            {isFiltered
              ? "Explore another category to discover helpful coding guidance and inspiring learner stories."
              : "We are preparing practical coding guidance, student stories and technology insights for families raising young creators."}
          </p>

          {isFiltered ? (
            <Link
              href="/blog#latest-stories"
              className="mt-7 inline-flex items-center gap-2 rounded-full bg-[#7651EF] px-5 py-3 text-sm font-black text-white"
            >
              View all stories
            ...
            <Link
              href="/book-class"
              className="mt-7 inline-flex items-center gap-2 rounded-full bg-[#FF3F7F] px-5 py-3 text-sm font-black text-white"
            >
  ...
  const resources = [
    {
      ...
      description:
        "Understand what coding looks like at different ages.",
...

    {
      ...
      description:
        "Discover how games and creativity make coding approachable.",

      icon: Lightbulb,

      href: "/blog?category=Coding%20for%20Kids",

      background:
        "from-[#F2F7FF] to-[#EAF2FF]",
...

    {
      ...
      description:
        "See what young learners can build with the right support.",

      icon: GraduationCap,

      href: "/blog?category=Student%20Stories",
    ...
    <section className="bg-white py-16 sm:py-20">
      <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
        <div className="mb-9 max-w-2xl">
          ...
          <h2 className="mt-2 text-3xl font-black tracking-tight text-[#2947C7] sm:text-4xl">
            Find what helps your
            child grow.
          </h2>

          <p className="mt-4 text-base leading-7 text-slate-600">
            Discover ideas and guidance
            ...
            (resource) => {
              ...
              return (
                <Link
                  ...
                  className={`group rounded-[1.75rem] border border-white bg-gradient-to-br p-6 transition duration-300 hover:-translate-y-1 hover:shadow-lg ${resource.background}`}
                >
                  <span
                    className={`inline-flex h-12 w-12 items-center justify-center rounded-2xl ${resource.iconBackground} ${resource.iconColor}`}
                  >
                    <Icon
                      size={22}
                    />
                  ...
                  <span
                    className={`mt-5 inline-flex items-center gap-2 text-sm font-black ${resource.iconColor}`}
                  >
                    Explore
...
function FounderNote() {
  return (
    <section className="border-t border-purple-50 bg-[#FCFAFF] py-16 sm:py-20">
      <div className="mx-auto max-w-6xl px-5 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-[2rem] border border-purple-100 bg-white p-7 shadow-sm sm:p-10">
          <div className="pointer-events-none absolute -right-20 -top-20 h-56 w-56 rounded-full bg-purple-100/60 blur-3xl" />

          <div className="pointer-events-none absolute -bottom-28 left-1/3 h-52 w-52 rounded-full bg-pink-100/50 blur-3xl" />

          <div className="relative grid items-center gap-8 md:grid-cols-[150px_1fr]">
            <div className="relative mx-auto h-36 w-36 overflow-hidden rounded-[1.75rem] border-4 border-white bg-purple-100 shadow-xl md:mx-0">
              <Image
                src="/founder.jpg"
            ...
            <div className="text-center md:text-left">
              <span className="inline-flex items-center gap-2 rounded-full bg-pink-50 px-3 py-1.5 text-[11px] font-black uppercase tracking-[0.14em] text-[#FF3F7F]">
                <Heart
                  size={13}
                  fill="currentColor"
                />
              ...
              <h2 className="mt-4 text-2xl font-black leading-tight text-[#2947C7] sm:text-3xl">
              ...
              <p className="mt-5 text-sm font-black text-[#2947C7]">
                — Justin Akinyi,
                Founder
              </p>
            </div>
...
function BlogCallToAction() {
  return (
    <section className="bg-white px-5 py-16 sm:px-6 sm:py-20 lg:px-8">
      <div className="relative mx-auto max-w-6xl overflow-hidden rounded-[2rem] bg-gradient-to-br from-[#2947C7] via-[#594BE1] to-[#7951EF] px-7 py-10 text-white shadow-2xl shadow-purple-950/15 sm:px-12 sm:py-12">
        <div className="pointer-events-none absolute -left-24 -top-24 h-64 w-64 rounded-full bg-white/10" />

        <div className="pointer-events-none absolute -bottom-28 right-0 h-72 w-72 rounded-full bg-pink-300/20 blur-2xl" />

        <div className="relative flex flex-col items-start justify-between gap-8 md:flex-row md:items-center">
          <div className="max-w-2xl">
            <span className="inline-flex items-center gap-2 rounded-full bg-white/15 px-3 py-1.5 text-[11px] font-black uppercase tracking-[0.14em] text-white">
              <Sparkles size={13} />
            ...
            <p className="mt-4 max-w-xl text-sm leading-7 text-white/85 sm:text-base">
              ...
              coding classes designed
              around your child’s age,
          ...
          <Link
            href="/book-class"
            className="inline-flex shrink-0 items-center gap-2 rounded-xl bg-[#FF6B63] px-6 py-3.5 text-sm font-black text-white shadow-lg shadow-black/10 transition hover:-translate-y-0.5 hover:bg-[#FF5951]"
          >
            Book a trial class
