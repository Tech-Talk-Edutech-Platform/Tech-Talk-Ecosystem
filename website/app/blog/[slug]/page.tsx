...
function shouldShowBenefitsCards(
  ...
  return (
    ...
    value.includes("why coding matters")
  );
}
...
function shouldShowChecklist(
  ...
  return (
    value.includes("good coding class") ||
    value.includes("choose the right coding")
  );
}
  ...
  const groups = [
    {
      ...
      iconBackground: "bg-[#E8DEFF]",

      iconColor: "text-[#7951EF]",
...

    {
      ...
      iconBackground: "bg-[#DCEBFF]",

      iconColor: "text-[#3266E8]",

      border: "border-[#DDEAFF]",
    },

    {
      ...
      description:
        "Explore apps, AI, data science and real-world projects.",
      ...
      iconBackground: "bg-[#FFE1D8]",

      iconColor: "text-[#F56746]",

      border: "border-[#FFE0D6]",
    },
  ];
  ...
  const benefits = [
    {
      ...
      iconBackground: "bg-[#E8DDFF]",

      iconColor: "text-[#7853EE]",
    },

    {
      ...
      description:
        "Turn ideas into games, stories and apps.",
...

    {
      ...
      background: "bg-[#FFF2EE]",

      iconBackground: "bg-[#FFE0D8]",

      iconColor: "text-[#F36649]",
    },

    {
      ...
      background: "bg-[#EEFAF7]",

      iconBackground: "bg-[#D8F4EC]",

      iconColor: "text-[#11A487]",
    },
  ];
...
function LearningChecklist() {
  const items = [
    {
      label: "Age-appropriate lessons",
      icon: Blocks,
    },

    {
      label: "Live tutor guidance",
      icon: UserRound,
    },
    ...
    {
      label: "A clear learning pathway",
      icon: Rocket,
    },
      ...
      <ReactMarkdown
        ...
        components={{
          h1({ children }) {
            ...
            return (
              <h2
                ...
                className="mb-5 mt-14 scroll-mt-28 text-3xl font-black leading-tight text-[#2947C7] sm:text-4xl"
              >
                {children}
              </h2>
            );
          ...
          p({ children, node }) {
            ...
            return (
              <p className="my-5 text-base leading-8 text-slate-600 sm:text-[17px]">
                {children}
              </p>
            );
          },
  ...
  return (
    <aside className="hidden lg:block">
      <div className="sticky top-28 space-y-6">
        {headings.length > 0 && (
          <div className="rounded-[1.75rem] border border-purple-100 bg-[#FCFAFF] p-5 shadow-sm">
        ...
        <div className="rounded-[1.75rem] border border-purple-100 bg-gradient-to-br from-[#F7F3FF] to-[#F0E9FF] p-5">
      ...
      <div className="grid items-center gap-7 p-7 sm:p-9 md:grid-cols-[1fr_190px]">
        <div className="relative z-10">
          ...
          <p className="mt-3 max-w-lg text-sm leading-7 text-white/85 sm:text-base">
            ...
            classes that help young
            learners build, create
          ...
          <Link
            href="/book-class"
            className="mt-6 inline-flex items-center gap-2 rounded-xl bg-[#FF6B63] px-5 py-3 text-sm font-black text-white transition hover:bg-[#FF5951]"
          >
            Book a trial class
...
export async function generateMetadata({
  ...
  return {
    ...
    description:
      post.excerpt ||
      "Discover helpful insights about coding and technology education for young learners.",
...
//       {shouldShowAgeCards(title, content) && (
//         <AgeGroupCards />
//       )}

//       {shouldShowBenefitsCards(title) && (
//         <BenefitsCards />
//       )}

//       {shouldShowChecklist(title) && (
//         <LearningChecklist />
//       )}
//     </>
//   );
