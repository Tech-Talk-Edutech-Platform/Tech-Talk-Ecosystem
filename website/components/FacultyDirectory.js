...
import FacultyGrid from './FacultyGrid'; // We will create this next
...
export default async function FacultyDirectoryPage() {
  ...
  return (
    <div className="bg-slate-50 min-h-screen py-8 px-3 sm:px-12 lg:px-24">
...
// import { client, urlFor } from '../lib/sanity'; // Ensure this path is correct
...
// //               {member.image && (
// //                 <Image 
// //                   // Updated to use the builder correctly
...
// <article 
//   key={member._id} 
//   className="bg-white p-8 rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.05)] border border-slate-100 flex flex-col h-full"
// >
...
//     <h3 className="text-xl font-bold text-slate-900">{member.name}</h3>
//     <p className="text-pink-600 font-semibold mb-3">{member.title}</p>
//     <p className="text-slate-500 text-sm mb-6 leading-relaxed line-clamp-3 text-center">
//       {member.bio}
//     </p>
//   </div>

//   {/* Footer is now pushed to the bottom consistently */}
