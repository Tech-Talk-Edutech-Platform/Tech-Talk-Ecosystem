...
// import { supabase } from "../supabase";
// import toast from "react-hot-toast";
// import { X, Send, FilePlus, ChevronRight } from "lucide-react";

// export default function QuickActions({ tutorId }) {
//   const [modalType, setModalType] = useState(null); // 'message' or 'assignment'
//   const [students, setStudents] = useState([]);
//   const [selectedStudent, setSelectedStudent] = useState(null);
//   const [loading, setLoading] = useState(false);
...
//     } else {
//       toast.success(`Task assigned to ${selectedStudent.full_name}`);
//       closeModal();
//     }
//     setLoading(false);
//   };
...
//   const actions = [
//     { label: "Start Next Class", color: "bg-blue-600", icon: "🚀", onClick: () => {} },
...
//   return (
//     <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm relative">
//       <h3 className="font-bold text-slate-800 mb-5 text-lg">Quick Actions</h3>
//       <div className="space-y-3">
//         {actions.map((btn) => (
//           <button 
//             key={btn.label}
...
//                   <>
//                     <input 
//                       type="text" placeholder="Task Name (e.g. Loop Practice)" 
...
//                     </select>
//                     <input 
//                       type="url" placeholder="Resource URL (Optional)" 
//                       className="w-full p-4 bg-slate-50 border border-slate-100 rounded-2xl outline-none"
