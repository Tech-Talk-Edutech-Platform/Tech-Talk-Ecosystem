...
//         <Icon
//           size={28}
//           className={`mb-2 ${colorMap[color] || "text-blue-500"}`}
//         />
//       )}
//         {title}
//       </h4>
...
// // export default function StatCard({ title, icon,value, color = "blue" }) {
// //   const colorMap = {
...
// //         <div className={`w-10 h-1.5 rounded-full mt-3 border-b-4 transition-all group-hover:w-16 ${colorMap[color] || 'border-blue-500'}`}></div>
// //       </div>
// //     </div>
// //   );
// // }
