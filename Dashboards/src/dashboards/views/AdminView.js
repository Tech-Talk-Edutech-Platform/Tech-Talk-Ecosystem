...
//             <div className="space-y-3">
//               {upcoming.length === 0 ? (
//                 <p className="text-[10px] text-slate-400 font-bold italic">No classes scheduled today.</p>
//               ) : (
//                 upcoming.map(c => {
//                   const now = new Date();
...
//                   return (
//                     <div key={c.id} className={`p-4 border border-slate-50 rounded-2xl ${isNow ? "bg-emerald-50/50" : "bg-slate-50/30"}`}>
//                       <div className="flex justify-between items-start">
//                         <div>
//                           <p className="font-black text-slate-900 text-xs leading-tight">{c.title}</p>
//                           <p className="text-[10px] font-bold text-blue-600 mt-1 uppercase">
//                             {start.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })} • {c.tutors?.full_name} {isNow && <span className="text-[8px] bg-red-500 text-white px-1 py-0.5 rounded ml-2 uppercase">Happening Now</span>}
//                           </p>
//                         </div>
//                         <button
//                           onClick={() => {
