...
//   const [leads, setLeads] = useState([]);
//   const [loading, setLoading] = useState(true);
//   const [activeTab, setActiveTab] = useState(TAB_TYPES.TODAY);
...
//       if (!l.next_follow_up_at) return true;
//       const d = new Date(l.next_follow_up_at);
//       if (activeTab === TAB_TYPES.OVERDUE) return d < now;
//       if (activeTab === TAB_TYPES.TODAY) return d >= start && d <= end;
//       if (activeTab === TAB_TYPES.UPCOMING) return d > end;
...
// //       setLeads((prev) => [data, ...prev]);
// //       setShowAddLead(false);
// //       setNewLead({ parent_name: "", phone: "", email: "", next_follow_up_at: "" });
// //       setErrors({});
// //     }
// //   };
...
// //       setLeads((prev) =>
// //         prev.map((l) =>
// //           l.id === id ? { ...l, ...data, follow_up_missed: false } : l
// //         )
// //       );
// //     }
// //   };
...
// //               value={newLead.parent_name}
// //               onChange={(e) =>
// //                 setNewLead({ ...newLead, parent_name: e.target.value })
// //               }
// //             />
// //             {errors.parent_name && (
// //               <p className="text-red-500 text-xs">{errors.parent_name}</p>
// //             )}
...
// //               value={newLead.grade}
// //               onChange={(e) =>
// //                 setNewLead({ ...newLead, grade: e.target.value })
// //               }
// //             />
...
// //               value={newLead.class_date}
// //               onChange={(e) =>
// //                 setNewLead({ ...newLead, class_date: e.target.value })
// //               }
// //             />
...
// //               value={newLead.class_time}
// //               onChange={(e) =>
// //                 setNewLead({ ...newLead, class_time: e.target.value })
// //               }
// //             />
...
// //               value={newLead.next_follow_up_at}
// //               onChange={(e) =>
// //                 setNewLead({ ...newLead, next_follow_up_at: e.target.value })
// //               }
// //             />
...
// //         <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
// //           {filteredLeads.map((l) => (
// //             <div key={l.id} className="p-6 rounded-[32px] border bg-white">
// //               <div className="flex justify-between mb-1">
// //                 <span className="text-xs font-black uppercase">{l.status}</span>
...
// //                 <button
// //                   onClick={() => updateStatus(l.id, "contacted")}
// //                   className="px-3 py-1 bg-blue-100 rounded-full text-xs"
// //                 >
// //                   Contacted
// //                 </button>
...
// //                 <button
// //                   onClick={() => updateStatus(l.id, "converted")}
// //                   className="px-3 py-1 bg-emerald-100 rounded-full text-xs"
// //                 >
// //                   Convert
// //                 </button>
// //               </div>
